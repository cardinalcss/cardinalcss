...
*This is mostly extracted from this [CONTRIBUTING.md](https://github.com/necolas/normalize.css/edit/master/CONTRIBUTING.md) document.*

Before making a contribution, please take a moment to review this document to make the process easier and more enjoyable for everyone involved.

Following the guidelines in this document shows that you respect the time of the developers managing this open-source project. In return, they should show their respect for you by addressing your requests, issues, and contributions in a timely fashion.

## Submitting issues

GitHub’s built-in issue tracker is the preferred channel for bug reports, feature requests, and submitting pull requests.

**Do not** use the issue tracker for personal support questions.
...
A bug is a problem that you can demonstrate to a managing developer. Good bug reports are very helpful!

1. **Search for existing issues** - it may have already been reported.
2. **Check for fixes** - try to reproduce the bug using the latest release on the `master` branch  in the repository.
3. **If the problem persists**, submit an issue and create a live example using something like [jsFiddle](http://jsfiddle.net) or [Codepen](http://codepen.io).
...
Feel free to requests whatever you like, but please take a moment to think about whether your request is within the scope of the project. You should make a strong case for your request, otherwise the managing developers will probably not consider it. Provide as much detail as you can.
